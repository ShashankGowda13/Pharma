...
router.post('/', protect, adminOnly, upload.single('image'), productBodyRules, product.create);
router.put('/:id', protect, adminOnly, upload.single('image'), productBodyRules, product.update);
